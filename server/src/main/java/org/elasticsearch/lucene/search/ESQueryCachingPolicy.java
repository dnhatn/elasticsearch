...
public interface ESQueryCachingPolicy extends org.apache.lucene.search.QueryCachingPolicy {
   ...
   */
  default boolean shouldCache(Query query, LeafReaderContext context) throws IOException {
    return shouldCache(query);
  }
}
