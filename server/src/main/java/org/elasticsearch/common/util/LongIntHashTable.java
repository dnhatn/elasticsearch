...
/**
 * A hash table mapping keys (pair of long/int) to values to ids.
 * The id's start at 0, and increment monotonically as
 * unique keys are added.
 */
public interface LongIntHashTable extends Releasable, Accountable {
