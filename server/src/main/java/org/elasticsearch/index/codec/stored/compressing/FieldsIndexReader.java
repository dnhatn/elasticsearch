...
import static org.elasticsearch.index.codec.stored.compressing.FieldsIndexWriter.VERSION_CURRENT;
import static org.elasticsearch.index.codec.stored.compressing.FieldsIndexWriter.VERSION_START;
...
final class FieldsIndexReader extends FieldsIndex {
    ...
    FieldsIndexReader(Directory dir, String name, String suffix, String extension, String codecName, byte[] id, IndexInput metaIn)
        ...
        indexInput = dir.openInput(IndexFileNames.segmentFileName(name, suffix, extension), IOContext.LOAD);
