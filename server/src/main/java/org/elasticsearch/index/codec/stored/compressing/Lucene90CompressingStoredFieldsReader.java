 ...
 */
package org.elasticsearch.index.codec.stored.compressing;
...
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.BYTE_ARR;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.DAY;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.DAY_ENCODING;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.FIELDS_EXTENSION;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.HOUR;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.HOUR_ENCODING;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.INDEX_CODEC_NAME;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.INDEX_EXTENSION;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.META_EXTENSION;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.META_VERSION_START;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.NUMERIC_DOUBLE;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.NUMERIC_FLOAT;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.NUMERIC_INT;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.NUMERIC_LONG;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.SECOND;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.SECOND_ENCODING;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.STRING;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.TYPE_BITS;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.TYPE_MASK;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.VERSION_CURRENT;
import static org.elasticsearch.index.codec.stored.compressing.Lucene90CompressingStoredFieldsWriter.VERSION_START;
        ...
        try {
            ...
            if (numChunks < numDirtyChunks) {
                throw new CorruptIndexException(
                    "Cannot have more dirty chunks than chunks: numChunks=" + numChunks + ", numDirtyChunks=" + numDirtyChunks,
                    metaIn
                );
            }
