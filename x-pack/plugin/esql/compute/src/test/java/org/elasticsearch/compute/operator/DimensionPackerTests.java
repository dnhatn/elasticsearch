...
public class DimensionPackerTests extends ComputeTestCase {
    ...
    public void testKeyword() {
        ...
        var encoded1 = DimensionPacker.packBytesValues(driverContext, block1);
        var encoded2 = DimensionPacker.packBytesValues(driverContext, block2);
        var decoded1 = DimensionPacker.unpackBytesValues(driverContext, encoded1.asVector());
        var decoded2 = DimensionPacker.unpackBytesValues(driverContext, encoded2.asVector());
        try {
    ...
    public void testLongs() {
        ...
        var encode1 = DimensionPacker.packLongValues(driverContext, block1);
        var encode2 = DimensionPacker.packLongValues(driverContext, block2);
        var decoded1 = DimensionPacker.unpackLongValues(driverContext, encode1.asVector());
        var decoded2 = DimensionPacker.unpackLongValues(driverContext, encode2.asVector());
        try {
            assertThat(decoded1, equalTo(block1));
            assertThat(decoded2, equalTo(block2));
            for (int p = 0; p < positionCount; p++) {
    ...
    public void testInts() {
        ...
        var encode1 = DimensionPacker.packIntValues(driverContext, block1);
        var encode2 = DimensionPacker.packIntValues(driverContext, block2);
        var decoded1 = DimensionPacker.unpackIntValues(driverContext, encode1.asVector());
        var decoded2 = DimensionPacker.unpackIntValues(driverContext, encode2.asVector());
        try {
            assertThat(decoded1, equalTo(block1));
            assertThat(decoded2, equalTo(block2));
            for (int p = 0; p < positionCount; p++) {
    ...
    public void testBoolean() {
        ...
        var encode1 = DimensionPacker.packBooleanValues(driverContext, block1);
        var encode2 = DimensionPacker.packBooleanValues(driverContext, block2);
        var decoded1 = DimensionPacker.unpackBooleanValues(driverContext, encode1.asVector());
        var decoded2 = DimensionPacker.unpackBooleanValues(driverContext, encode2.asVector());
        try {
            assertThat(decoded1, equalTo(block1));
            assertThat(decoded2, equalTo(block2));
            for (int p = 0; p < positionCount; p++) {
    ...
    public void testMultiColumns() {
        ...
        BytesRefBlock encoded1 = DimensionPacker.packMultiColumns(driverContext, blocks1);
        BytesRefBlock encoded2 = DimensionPacker.packMultiColumns(driverContext, blocks2);
        Block[] decoded1 = DimensionPacker.unpackMultiColumns(driverContext, encoded1, types);
        Block[] decoded2 = DimensionPacker.unpackMultiColumns(driverContext, encoded2, types);
        try {
