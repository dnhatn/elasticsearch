...
public final class TimeSeriesSourceOperator extends LuceneOperator {
    ...
    public Page getCheckedOutput() throws IOException {
        ...
        try {
            ...
            if (currentPagePos > 0) {
                ...
                blocks[1] = tsHashesBuilder.build().asBlock();
    ...
    static final class DocIdCollector implements Releasable {
        ...
        DocVector build() {
            ...
            try {
                ...
                docVector = buildDocVector(shards, segments, docs);
                return docVector;
            } finally {
                if (docVector == null) {
        ...
        private DocVector buildDocVector(IntVector shards, IntVector segments, IntVector docs) {
            return new DocVector(shards, segments, docs, segments.isConstant());
        }
    ...
    public Operator.Status status() {
        return new Status(this, tsidsLoaded, rowsEmitted);
    }
