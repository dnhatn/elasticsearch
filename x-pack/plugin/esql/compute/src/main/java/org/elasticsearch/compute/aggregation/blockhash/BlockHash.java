...
public abstract class BlockHash implements Releasable, SeenGroupIds {
    ...
    public void clear() {
        throw new UnsupportedOperationException(getClass().getSimpleName() + " doesn't support partition");
    }
    ...
    public PartitionedHashTable.PartitionedHashKeys splitPartition(CircuitBreaker breaker, PartitionedHashTable.PartitionSplitter partitionSplitter) {
        throw new UnsupportedOperationException(getClass().getSimpleName() + " doesn't support partition");
    }

    public boolean combinePartition(PartitionedHashTable.PartitionedHashKeys keys, int partitionIndex, int totalSizeAcrossPartitions, int[] resultIds) {
        throw new UnsupportedOperationException(getClass().getSimpleName() + " doesn't support partition");
    }
}
