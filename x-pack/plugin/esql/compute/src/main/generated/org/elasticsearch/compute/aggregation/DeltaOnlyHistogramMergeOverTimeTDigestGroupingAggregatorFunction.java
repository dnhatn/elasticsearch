...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link DeltaOnlyHistogramMergeOverTimeTDigestAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class DeltaOnlyHistogramMergeOverTimeTDigestGroupingAggregatorFunction implements GroupingAggregatorFunction {
  private static final List<IntermediateStateDesc> INTERMEDIATE_STATE_DESC = List.of(
      new IntermediateStateDesc("value", ElementType.TDIGEST),
      new IntermediateStateDesc("seen", ElementType.BOOLEAN)  );

  private final DeltaOnlyHistogramMergeOverTimeTDigestAggregator.TemporalityAwareTDigestGroupingState state;
  ...
  DeltaOnlyHistogramMergeOverTimeTDigestGroupingAggregatorFunction(Warnings warnings,
      List<Integer> channels, DriverContext driverContext) {
    this.warnings = warnings;
    this.channels = channels;
    this.state = DeltaOnlyHistogramMergeOverTimeTDigestAggregator.initGrouping(driverContext.bigArrays(), driverContext, warnings);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = DeltaOnlyHistogramMergeOverTimeTDigestAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
