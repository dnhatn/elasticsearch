...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link SpatialExtentGeoShapeCombinedDocValuesAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class SpatialExtentGeoShapeCombinedDocValuesGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = SpatialExtentGeoShapeCombinedDocValuesAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
