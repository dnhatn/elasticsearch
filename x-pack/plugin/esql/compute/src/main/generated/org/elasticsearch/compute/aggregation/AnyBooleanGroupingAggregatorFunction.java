...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AnyBooleanAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class AnyBooleanGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private final AnyBooleanAggregator.GroupingState state;
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AnyBooleanAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
