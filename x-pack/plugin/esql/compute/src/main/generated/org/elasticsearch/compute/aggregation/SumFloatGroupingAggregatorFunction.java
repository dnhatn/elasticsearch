...
public final class SumFloatGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  SumFloatGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext) {
    this.channels = channels;
    this.state = SumFloatAggregator.initGrouping(driverContext.bigArrays());
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = SumFloatAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
