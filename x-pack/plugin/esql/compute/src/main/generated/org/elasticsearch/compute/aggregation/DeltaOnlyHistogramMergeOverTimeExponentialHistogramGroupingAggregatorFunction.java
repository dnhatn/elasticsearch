...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link DeltaOnlyHistogramMergeOverTimeExponentialHistogramAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class DeltaOnlyHistogramMergeOverTimeExponentialHistogramGroupingAggregatorFunction implements GroupingAggregatorFunction {
  private static final List<IntermediateStateDesc> INTERMEDIATE_STATE_DESC = List.of(
      new IntermediateStateDesc("value", ElementType.EXPONENTIAL_HISTOGRAM),
      new IntermediateStateDesc("seen", ElementType.BOOLEAN)  );

  private final DeltaOnlyHistogramMergeOverTimeExponentialHistogramAggregator.TemporalityAwareExpHistGroupingState state;
  ...
  DeltaOnlyHistogramMergeOverTimeExponentialHistogramGroupingAggregatorFunction(Warnings warnings,
      List<Integer> channels, DriverContext driverContext) {
    this.warnings = warnings;
    this.channels = channels;
    this.state = DeltaOnlyHistogramMergeOverTimeExponentialHistogramAggregator.initGrouping(driverContext.bigArrays(), driverContext, warnings);
  ...
  public GroupingAggregatorFunction.AddInput prepareProcessRawInputPage(SeenGroupIds seenGroupIds,
    ...
    BytesRefBlock temporalityBlock = page.getBlock(channels.get(1));
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = DeltaOnlyHistogramMergeOverTimeExponentialHistogramAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
