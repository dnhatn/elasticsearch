...
public final class AllFirstLongByIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  AllFirstLongByIntGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext) {
    this.channels = channels;
    this.state = AllFirstLongByIntAggregator.initGrouping(driverContext);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AllFirstLongByIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
