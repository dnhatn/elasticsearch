...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link LastBytesRefByTimestampAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class LastBytesRefByTimestampGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = LastBytesRefByTimestampAggregator.evaluateFinal(state, selectedInPage, ctx);
  }
