...
public class InternalPackValues extends UnaryScalarFunction {
    public InternalPackValues(Source source, Expression field) {
        super(source, field);
    }
    ...
    public String getWriteableName() {
        throw new UnsupportedOperationException("InternalPackValues must be used on the coordinator only");
    }
    ...
    public Expression replaceChildren(List<Expression> newChildren) {
        return new InternalPackValues(source(), newChildren.get(0));
    }

    @Override
    protected NodeInfo<? extends Expression> info() {
        return NodeInfo.create(this, InternalPackValues::new, field());
    }
