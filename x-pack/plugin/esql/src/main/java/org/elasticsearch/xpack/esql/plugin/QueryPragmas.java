...
public final class QueryPragmas implements Writeable {
    ...
    public static final Setting<Integer> TIME_SERIES_MAX_DOC_INTERVALS = Setting.intSetting("time_series.max_doc_interval",10_000_000, 1);
    ...
    public int timeSeriesMaxDocIntervals() {
        return TIME_SERIES_MAX_DOC_INTERVALS.get(settings);
    }
