...
public class IndexResolver {
     ...
     */
    public void resolveAsMergedMapping(String indexWildcard, QueryBuilder indexFilter, Set<String> fieldNames, ActionListener<IndexResolution> listener) {
        client.execute(
            EsqlResolveFieldsAction.TYPE,
            createFieldCapsRequest(indexWildcard, indexFilter, fieldNames),
    ...
    private static FieldCapabilitiesRequest createFieldCapsRequest(String index, QueryBuilder indexFilter, Set<String> fieldNames) {
