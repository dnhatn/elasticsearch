...
public class InternalUnpackValues extends UnaryScalarFunction {
    private final DataType resultType;

    public InternalUnpackValues(Source source, Expression field, DataType resultType) {
        super(source, field);
    ...
    public String getWriteableName() {
        throw new UnsupportedOperationException("InternalUnpackValues must be used on the coordinator only");
    }
    ...
    public Expression replaceChildren(List<Expression> newChildren) {
        return new InternalUnpackValues(source(), newChildren.get(0), resultType);
    }

    @Override
    protected NodeInfo<? extends Expression> info() {
        return NodeInfo.create(this, InternalUnpackValues::new, field(), dataType());
    }
