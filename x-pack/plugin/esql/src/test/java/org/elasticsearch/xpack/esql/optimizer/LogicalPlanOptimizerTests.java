...
public class LogicalPlanOptimizerTests extends AbstractLogicalPlanOptimizerTests {
    ...
    public void testTranslateMetricsGroupedByOneDimension() {
        ...
        UnpackDimensionValues unpack = as(topN.child(), UnpackDimensionValues.class);
    ...
    public void testTranslateMetricsGroupedByTwoDimension() {
        ...
        UnpackDimensionValues unpack = as(limit.child(), UnpackDimensionValues.class);
    ...
    public void testTranslateMetricsWithAliasToDimensionInGroup() {
        ...
        var limit = as(project.child(), Limit.class);
        // UnpackDimensionValues[group_$1, [p]]
        var unpack = as(limit.child(), UnpackDimensionValues.class);
        assertThat(unpack.unpackedDimensions(), hasSize(1));
        assertThat(unpack.unpackedDimensions().getFirst().name(), equalTo("p"));
        // Aggregate[[bucket, packed_$1], [MAX(..) AS max(..), bucket, packed_$1 AS group_$1]]
